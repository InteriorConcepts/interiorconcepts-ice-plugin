...
public class ICDCurvedTopExtrusion extends ICDTopExtrusion
{
    public ICDCurvedTopExtrusion(final String s, final TypeObject typeObject, final OptionObject optionObject) {
        super(s, typeObject, optionObject);
    }
    
    @Override
    public Object clone() {
        return this.buildClone(new ICDCurvedTopExtrusion(this.getId(), this.currentType, this.currentOption));
    }
    
    public ICDCurvedTopExtrusion buildClone(final ICDCurvedTopExtrusion icdCurvedTopExtrusion) {
        super.buildClone(icdCurvedTopExtrusion);
        return icdCurvedTopExtrusion;
    }
    
    @Override
    public EntityObject frameClone(final EntityObject entityObject) {
        return (EntityObject)this.buildFrameClone(new ICDCurvedTopExtrusion(this.getId(), this.currentType, this.currentOption), entityObject);
    }
    
    public ICDCurvedTopExtrusion buildFrameClone(final ICDCurvedTopExtrusion icdCurvedTopExtrusion, final EntityObject entityObject) {
        super.buildFrameClone(icdCurvedTopExtrusion, entityObject);
        return icdCurvedTopExtrusion;
    }
