...
public class ICDCurvedBottomExtrusion extends ICDBottomExtrusion
{
    public ICDCurvedBottomExtrusion(final String s, final TypeObject typeObject, final OptionObject optionObject) {
        super(s, typeObject, optionObject);
    }
    
    @Override
    public Object clone() {
        return this.buildClone(new ICDCurvedBottomExtrusion(this.getId(), this.currentType, this.currentOption));
    }
    
    public ICDCurvedBottomExtrusion buildClone(final ICDCurvedBottomExtrusion icdCurvedBottomExtrusion) {
        super.buildClone(icdCurvedBottomExtrusion);
        return icdCurvedBottomExtrusion;
    }
    
    @Override
    public EntityObject frameClone(final EntityObject entityObject) {
        return (EntityObject)this.buildFrameClone(new ICDCurvedBottomExtrusion(this.getId(), this.currentType, this.currentOption), entityObject);
    }
    
    public ICDCurvedBottomExtrusion buildFrameClone(final ICDCurvedBottomExtrusion icdCurvedBottomExtrusion, final EntityObject entityObject) {
        super.buildFrameClone(icdCurvedBottomExtrusion, entityObject);
        return icdCurvedBottomExtrusion;
    }
