...
import net.iceedge.icecore.basemodule.baseclasses.panels.BasicEndExtrusion;

public class ICDEndExtrusion extends BasicEndExtrusion implements ICDVerticalExtrusion, JointIntersectable, ICDExtrusionInterface, ICDManufacturingReportable
{
    private Vector<ICDSubInternalExtrusion> tubings;
    private Vector<ICDMiddleJoint> joints;
    
    public ICDEndExtrusion(final String s, final TypeObject typeObject, final OptionObject optionObject) {
    ...
    public Object clone() {
        return this.buildClone(new ICDEndExtrusion(this.getId(), this.currentType, this.currentOption));
    }
    
    public ICDEndExtrusion buildClone(final ICDEndExtrusion icdEndExtrusion) {
        super.buildClone((BasicEndExtrusion)icdEndExtrusion);
        return icdEndExtrusion;
    }
    
    public EntityObject frameClone(final EntityObject entityObject) {
        return (EntityObject)this.buildFrameClone(new ICDEndExtrusion(this.getId(), this.currentType, this.currentOption), entityObject);
    }
    
    public ICDEndExtrusion buildFrameClone(final ICDEndExtrusion icdEndExtrusion, final EntityObject entityObject) {
        super.buildFrameClone((BasicSurroundingStickExtrusion)icdEndExtrusion, entityObject);
        return icdEndExtrusion;
    }
    ...
    protected void calculateNamedPoints() {
        ...
        final PanelInterface parentPanel = this.getParentPanel();
        if (parentPanel instanceof ICDCurvedPanel || parentPanel instanceof ICDAngledPanel) {
            ...
            if (namedPointLocal != null) {
                namedPointLocal.set(0.0f, 0.0f, n);
            }
        }
    }
