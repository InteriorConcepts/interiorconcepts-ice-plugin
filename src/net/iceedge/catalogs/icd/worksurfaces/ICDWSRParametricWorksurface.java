...
public class ICDWSRParametricWorksurface extends ICDParametricWorksurface implements ICD1Width2Way1DepthGrippable
{
    ...
    public ICDWSRParametricWorksurface(final String s, final TypeObject typeObject, final OptionObject optionObject) {
    ...
    public ICDWSRParametricWorksurface(final String s, final String s2, final TypeObject typeObject, final OptionObject optionObject) {
    ...
    @Override
    public Object clone() {
        return this.buildClone(new ICDWSRParametricWorksurface(this.getId(), this.currentType, this.currentOption));
    }
    
    public ICDWSRParametricWorksurface buildClone(final ICDWSRParametricWorksurface icdwsrParametricWorksurface) {
        super.buildClone(icdwsrParametricWorksurface);
        icdwsrParametricWorksurface.calculateParameters();
        return icdwsrParametricWorksurface;
    }
