...
public class ICDWSAParametricWorksurface extends ICDCornerParametricWorksurface implements ICD2Widths2DepthsGrippable
{
    ...
    public ICDWSAParametricWorksurface(final String s, final TypeObject typeObject, final OptionObject optionObject) {
    ...
    @Override
    public Object clone() {
        return this.buildClone(new ICDWSAParametricWorksurface(this.getId(), this.currentType, this.currentOption));
    }
    
    public ICDWSAParametricWorksurface buildClone(final ICDWSAParametricWorksurface icdwsaParametricWorksurface) {
        super.buildClone(icdwsaParametricWorksurface);
        icdwsaParametricWorksurface.calculateParameters();
        return icdwsaParametricWorksurface;
    }
