...
public abstract class ICDParametricCutout extends TransformableEntity implements PlotPaintable, ICDManufacturingReportable
{
    ...
    public void addToSolution(final Solution solution) {
        ...
        final Iterator<Object> breadthFirstEnumerationIterator = solution.getBreadthFirstEnumerationIterator();
        while (breadthFirstEnumerationIterator.hasNext()) {
            final Object entityObject = breadthFirstEnumerationIterator.next();
            if (entityObject instanceof EntityObject && entityObject instanceof ICDParametricWorksurface) {
