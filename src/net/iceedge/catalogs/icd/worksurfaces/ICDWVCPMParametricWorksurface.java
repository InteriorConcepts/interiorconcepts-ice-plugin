...
public class ICDWVCPMParametricWorksurface extends ICDParametricWorksurface
{
    ...
    public ICDWVCPMParametricWorksurface(final String s, final TypeObject typeObject, final OptionObject optionObject) {
    ...
    public ICDWVCPMParametricWorksurface(final String s, final String s2, final TypeObject typeObject, final OptionObject optionObject) {
    ...
    @Override
    public Object clone() {
        return this.buildClone(new ICDWVCPMParametricWorksurface(this.getId(), this.currentType, this.currentOption));
    }
    
    public ICDWVCPMParametricWorksurface buildClone(final ICDWVCPMParametricWorksurface icdwvcpmParametricWorksurface) {
        super.buildClone(icdwvcpmParametricWorksurface);
        icdwvcpmParametricWorksurface.calculateParameters();
        return icdwvcpmParametricWorksurface;
    }
    ...
    protected void calculateParameters() {
        ...
        final Point3f point3f = new Point3f(attributeValueAsFloat / 2.0f, -(attributeValueAsFloat2 / 2.0f - 6.0f), 0.0f);
        final Point3f point3f2 = new Point3f(-attributeValueAsFloat / 2.0f, -(attributeValueAsFloat2 / 2.0f - 6.0f), 0.0f);
        final Point3f point3f3 = new Point3f(attributeValueAsFloat / 2.0f, attributeValueAsFloat2 / 2.0f - attributeValueAsFloat3, 0.0f);
        final Point3f point3f4 = new Point3f(-attributeValueAsFloat / 2.0f, attributeValueAsFloat2 / 2.0f - attributeValueAsFloat3, 0.0f);
        final float n = attributeValueAsFloat2 / 2.0f - attributeValueAsFloat3 - (attributeValueAsFloat2 - attributeValueAsFloat3 - 6.0f) / 2.0f;
        this.topEdge.setStartPoint(startPoint);
        this.topEdge.setEndPoint(endPoint);
        this.leftEdge = new LineParameter(point3f4, startPoint);
        this.rightEdge = new LineParameter(endPoint, point3f3);
        this.bottomArc = new CircleParameter(point3f2, new Point3f(0.0f, -attributeValueAsFloat2 / 2.0f, 0.0f), point3f);
        this.leftArc = new CircleParameter(point3f2, new Point3f(-(attributeValueAsFloat / 2.0f - 3.0f), n, 0.0f), point3f4);
        this.rightArc = new CircleParameter(point3f3, new Point3f(attributeValueAsFloat / 2.0f - 3.0f, n, 0.0f), point3f);
        ...
        this.rightReturnFillet = new FilletParameter(this.rightEdge, this.rightArc, 1.125f, point3f3, true, false, true);
        this.leftReturnFillet = new FilletParameter(this.leftEdge, this.leftArc, 1.125f, point3f4, true, false, true);
        this.bottomRightFillet = new FilletParameter(this.rightArc, this.bottomArc, 1.125f, point3f, false, true);
        this.bottomLeftFillet = new FilletParameter(this.leftArc, this.bottomArc, 1.125f, point3f2, false, true);
    ...
    public void setupGripPainters() {
        ...
        this.width1Grip.addListener((GripListener)new GripListener() {
            public boolean gripChanged(final BasicAttributeGrip basicAttributeGrip, final String s, final String s2) {
                ICDWVCPMParametricWorksurface.this.width1GripChanged(s2);
                return true;
            }
        });
        ...
        this.width2Grip.addListener((GripListener)new GripListener() {
            public boolean gripChanged(final BasicAttributeGrip basicAttributeGrip, final String s, final String s2) {
                ICDWVCPMParametricWorksurface.this.width2GripChanged(s2);
                return true;
            }
        });
        ...
        this.depthGrip.addListener((GripListener)new GripListener() {
            public boolean gripChanged(final BasicAttributeGrip basicAttributeGrip, final String s, final String s2) {
                ICDWVCPMParametricWorksurface.this.depthGripChanged(s2);
                return true;
            }
        });
        ...
        this.returnDepthGrip.addListener((GripListener)new GripListener() {
            public boolean gripChanged(final BasicAttributeGrip basicAttributeGrip, final String s, final String s2) {
                ICDWVCPMParametricWorksurface.this.returnDepthGripChanged(s2);
                return true;
            }
        });
    }
