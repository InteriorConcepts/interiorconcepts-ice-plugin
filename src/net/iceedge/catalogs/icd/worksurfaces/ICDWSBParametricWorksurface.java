...
public class ICDWSBParametricWorksurface extends ICDCornerParametricWorksurface implements ICD2Widths2DepthsGrippable
{
    private static final float bottomArcRadius = 16.32f;
    ...
    public ICDWSBParametricWorksurface(final String s, final TypeObject typeObject, final OptionObject optionObject) {
    ...
    @Override
    public Object clone() {
        return this.buildClone(new ICDWSBParametricWorksurface(this.getId(), this.currentType, this.currentOption));
    }
    
    public ICDWSBParametricWorksurface buildClone(final ICDWSBParametricWorksurface icdwsbParametricWorksurface) {
        super.buildClone(icdwsbParametricWorksurface);
        icdwsbParametricWorksurface.calculateParameters();
        return icdwsbParametricWorksurface;
    }
    ...
    protected void calculateParameters() {
        ...
        final float n = attributeValueAsFloat4;
        final float n2 = -attributeValueAsFloat3;
        ...
        final Point3f point3f4 = new Point3f(n2 + attributeValueAsFloat2, 0.0f, 0.0f);
        final Point3f point3f5 = new Point3f(0.0f, n - attributeValueAsFloat, 0.0f);
        ...
        this.innerFillet = new FilletParameter(this.innerRightEdge, this.innerLeftEdge, this.getBottomArcRadius(), true);
        ...
        if (attributeValueAsFloat > 60.0f || attributeValueAsFloat2 > 60.0f) {
            ...
            if (attributeValueAsFloat > 60.0f) {
                key4.set(n2 + 2.5f, n - attributeValueAsFloat / 2.0f + 3.0f, 0.0f);
            }
            else if (attributeValueAsFloat2 > 60.0f) {
                key4.set(n2 + attributeValueAsFloat2 / 2.0f - 3.0f, n - 2.5f, 0.0f);
            }
        ...
        this.depth1Anchor = new Point3f(n2, -this.getBottomArcRadius() - (attributeValueAsFloat - (attributeValueAsFloat4 + this.getBottomArcRadius())) / 2.0f, 0.0f);
        this.depth2Anchor = new Point3f(this.getBottomArcRadius() + (attributeValueAsFloat2 - (attributeValueAsFloat3 + this.getBottomArcRadius())) / 2.0f, n, 0.0f);
    ...
    public float getWidth1Min() {
        ...
        return Math.max(minimumValueFromAttribute, MathUtilities.roundToNearestDecmial(this.getAttributeValueAsFloat("ICD_Parametric_Depth2") + this.getBottomArcRadius() + 2.0f + 0.25f, 0.5f));
    }
    ...
    public float getWidth2Min() {
        ...
        return Math.max(minimumValueFromAttribute, MathUtilities.roundToNearestDecmial(this.getAttributeValueAsFloat("ICD_Parametric_Depth1") + this.getBottomArcRadius() + 2.0f + 0.25f, 0.5f));
    }
