...
public class ICD1Width2Way1DepthGripset
{
    protected BasicAttributeGrip width1Grip;
    protected BasicAttributeGrip width2Grip;
    protected BasicAttributeGrip depth1Grip;
    protected ICD1Width2Way1DepthGrippable grippable;
    
    public ICD1Width2Way1DepthGripset(final ICD1Width2Way1DepthGrippable grippable) {
        this.grippable = null;
    ...
    public void setupGripPainters() {
        ...
        this.width1Grip.addListener((GripListener)new GripListener() {
            public boolean gripChanged(final BasicAttributeGrip basicAttributeGrip, final String s, final String s2) {
                ICD1Width2Way1DepthGripset.this.grippable.width1GripChanged(s2);
                return true;
            }
        });
        ...
        this.width2Grip.addListener((GripListener)new GripListener() {
            public boolean gripChanged(final BasicAttributeGrip basicAttributeGrip, final String s, final String s2) {
                ICD1Width2Way1DepthGripset.this.grippable.width2GripChanged(s2);
                return true;
            }
        });
        ...
        this.depth1Grip.addListener((GripListener)new GripListener() {
            public boolean gripChanged(final BasicAttributeGrip basicAttributeGrip, final String s, final String s2) {
                ICD1Width2Way1DepthGripset.this.grippable.depth1GripChanged(s2);
                return true;
            }
        });
    }
    ...
    public void selectGrips(final boolean selected) {
        this.width1Grip.setSelected(selected);
        this.width2Grip.setSelected(selected);
        this.depth1Grip.setSelected(selected);
    }
