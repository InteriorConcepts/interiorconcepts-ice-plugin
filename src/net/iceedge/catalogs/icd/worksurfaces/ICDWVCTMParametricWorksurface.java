...
public class ICDWVCTMParametricWorksurface extends ICDParametricWorksurface implements ICD2Widths2DepthsGrippable
{
    ...
    public ICDWVCTMParametricWorksurface(final String s, final TypeObject typeObject, final OptionObject optionObject) {
    ...
    public ICDWVCTMParametricWorksurface(final String s, final String s2, final TypeObject typeObject, final OptionObject optionObject) {
    ...
    @Override
    public Object clone() {
        return this.buildClone(new ICDWVCTMParametricWorksurface(this.getId(), this.currentType, this.currentOption));
    }
    
    public ICDWVCTMParametricWorksurface buildClone(final ICDWVCTMParametricWorksurface icdwvctmParametricWorksurface) {
        super.buildClone(icdwvctmParametricWorksurface);
        icdwvctmParametricWorksurface.calculateParameters();
        return icdwvctmParametricWorksurface;
    }
    ...
    protected void calculateParameters() {
        ...
        final Point3f key = new Point3f(0.0f, attributeValueAsFloat2 / 2.0f - 9.0f, 0.0f);
