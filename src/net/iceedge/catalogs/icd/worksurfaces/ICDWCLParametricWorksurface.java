...
public class ICDWCLParametricWorksurface extends ICDCornerParametricWorksurface implements ICD2Widths2DepthsGrippable
{
    ...
    public ICDWCLParametricWorksurface(final String s, final TypeObject typeObject, final OptionObject optionObject) {
    ...
    @Override
    public Object clone() {
        return this.buildClone(new ICDWCLParametricWorksurface(this.getId(), this.currentType, this.currentOption));
    }
    
    public ICDWCLParametricWorksurface buildClone(final ICDWCLParametricWorksurface icdwclParametricWorksurface) {
        super.buildClone(icdwclParametricWorksurface);
        icdwclParametricWorksurface.calculateParameters();
        return icdwclParametricWorksurface;
    }
    ...
    protected void calculateParameters() {
        ...
        final float attributeValueAsFloat4;
        final float n = attributeValueAsFloat4 = this.getAttributeValueAsFloat("ICD_Parametric_Depth2");
        final float n2 = -attributeValueAsFloat3;
        final float n3 = 23.0f;
        final Point3f point3f = new Point3f(n2, attributeValueAsFloat4, 0.0f);
        final Point3f point3f2 = new Point3f(n2 + attributeValueAsFloat2, attributeValueAsFloat4, 0.0f);
        final Point3f point3f3 = new Point3f(n2, attributeValueAsFloat4 - attributeValueAsFloat, 0.0f);
        ...
        this.width1Anchor = new Point3f(n2 + attributeValueAsFloat3 / 2.0f, attributeValueAsFloat4, 0.0f);
        this.width2Anchor = new Point3f(n2, attributeValueAsFloat4 - n / 2.0f, 0.0f);
        this.depth1Anchor = new Point3f(n2, -((attributeValueAsFloat - n) / 2.0f), 0.0f);
    ...
    public float getWidth1Min() {
        ...
        return Math.max(minimumValueFromAttribute, MathUtilities.roundToNearestDecmial(this.getAttributeValueAsFloat("ICD_Parametric_Depth2") + 2.25f + 0.25f, 0.5f));
    }
    ...
    public float getWidth2Min() {
        ...
        return Math.max(minimumValueFromAttribute, MathUtilities.roundToNearestDecmial(this.getAttributeValueAsFloat("ICD_Parametric_Depth1") + 2.25f + 0.25f, 0.5f));
    }
